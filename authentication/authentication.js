...
async function register(req, res) {
    ...
    try {
        ...
        const CheckUserExistQuery = `SELECT * FROM odfc.odfc_user_info WHERE personal_email = $1;`;
...
async function loginUser(req, res) {
  ...
  const checkUserNameQuery = `SELECT * FROM odfc.odfc_user_info WHERE "personal_email" = $1`;
